...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/Star_X_Network')
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/its-star-boi/Movie2/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🌹 sᴜʙsᴄʀɪʙᴇ ʏᴛ ᴄʜᴀɴɴᴇʟ 🌹", url='https://youtube.com/@its_star_boi'
                )
            ]
        ]
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You Star Boi♥️')
